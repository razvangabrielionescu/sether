...
var SpongeSharedLibsModule = (function () {
    function SpongeSharedLibsModule() {
    }
    SpongeSharedLibsModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    return SpongeSharedLibsModule;
}());
exports.SpongeSharedLibsModule = SpongeSharedLibsModule;
