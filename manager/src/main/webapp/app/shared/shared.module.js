...
var _1 = require('./');
var SpongeSharedModule = (function () {
    function SpongeSharedModule() {
    }
    SpongeSharedModule = __decorate([
        core_1.NgModule({
            imports: [
                _1.SpongeSharedLibsModule,
                _1.SpongeSharedCommonModule
            ],
            declarations: [
    ...
    return SpongeSharedModule;
}());
exports.SpongeSharedModule = SpongeSharedModule;
